...
operations that can be very slow on large datasets. Current reimplementations
of phyloseq functions include
...
* A general-purpose merging function `merge_taxa_vec()` that provides a
  vectorized version of phyloseq's `merge_taxa()` function.
* A function `tree_glom()` that performs direct phylogenetic merging of
